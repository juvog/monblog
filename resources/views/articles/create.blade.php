        ...
        <form method="POST" action="{{ route('articles.store') }}">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="subtitle" class="form-control @error('title') is-invalid  @enderror" placeholder="Sous-titre de votre article" />
            ...
            <div class="col-12">
                <div class="form-group">
                    <label> Contenu </label>
                    <textarea id="tinycme-editor" name="content" class="form-control w-100 @error('title') is-invalid  @enderror "> </textarea>
                    @error('content')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }} </strong> </span>
                    @enderror
                </div>
